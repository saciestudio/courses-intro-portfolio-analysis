...
[chart.Hist](http://www.rdocumentation.org/packages/PerformanceAnalytics/functions/chart.Histogram)
...
-  Compare the histograms of the returns in those two years. 
...
```{r}
# subsetting
sp500_2008 <- window(sp500_returns,startdate = as.Date(" "), enddate = as.Date(" ")  )
sp500_2014 <- 
# plotting
...
# solution code
# subsetting
sp500_2008 <- window(sp500_returns,startdate = as.Date("2008-01-01"), enddate = as.Date("2008-12-31 ")  )
sp500_2014 <- window(sp500_returns,startdate = as.Date("2014-01-01"), enddate = as.Date("2014-12-31 ")  )
# plotting
par( mfrow = c(1,2) , mar=c(3,2,2,2))
# histogram 2008
