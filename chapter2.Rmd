...
These daily prices are available in your workspace as the variable `sp500`, which is of the xts time series class.  
Our interest is in describing the monthly performance. To do so, we first need to aggregate the daily price series to end-of-month prices. We will then compute the monthly returns and visualize them in an attractive table.  
...
- The annualized Sharpe ratio is $\sqrt{12}$ times the monthly Sharpe ratio.
