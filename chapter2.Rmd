...
Do you recall the Sharpe Ra
tio from the video? The Sharpe Ratio is an important metric that tells us the return-to-volatility ratio. The Sharpe ratio is calculated by taking the mean of excess returns (returns - risk free rate), divided by the volatility of the returns. 
