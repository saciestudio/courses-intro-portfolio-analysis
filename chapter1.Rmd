...
The gross returns over two periods is obtained similarly. Let *$R_1$* be the return in the first period and *$R_2$* the return in the second period. Then the end-value of a 1 USD investment is  $(1+R_1)\times(1+R_2)$ . 

The corresponding simple return over those two periods is: $(1+R_1)\times(1+R_2)-1$ . 
