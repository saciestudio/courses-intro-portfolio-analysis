...
The gross returns over two periods is obtained similarly. Let $R_1$ be the return in the first period and $R_2$ the return in the second period, then the end-value of a \$1 investment is $(1+R_1)*(1+R_2)$. The corresponding simple return over those two periods is $(1+R_1)*(1+R_2)-1$. 

Suppose the investor now has a horizon of two periods and in the first period, she makes a 10% return, but in the second period a loss of 5%. Use the R console to compute the end value and the simple return of an initial investment of $1000 investment.  Which of the three following answers do you obtain?


*** =instructions
- End-value = 1155. Simple 2-period return: .
- End-value = 1045. Simple 2-period return: .
- End-value = 1050. Simple 2-period return: .
...
## Computing the time series of portfolio returns
