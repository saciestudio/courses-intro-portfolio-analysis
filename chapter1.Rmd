...
*** =hint
If you’re struggling, remember that diversification is about making portfolios in which the loss on one asset can be compensated by the gains on the other assets in the portfolio.
