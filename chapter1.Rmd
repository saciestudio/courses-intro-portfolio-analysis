...
#5th instruction
test_function("head", "x", not_called_msg = "It looks like you didn't print the head of your returns!")
...
```{r}
#1
test_object("weights", undefined_msg = "Remember to create a vector of two equally weighted assets!", incorrect_msg = "Don't forget that asset weights need to sum to unity.")
#2 
test_object("pf_bh", undefined_msg = "Oops! It looks like you forgot to make `pf_bh`!")
test_object("pf_rebal", undefined_msg = "Uh, oh! You need to make a portfolio that rebalances monthly!", incorrect_msg = "Did you forget to rebalance your portfolio?")

test_function("plot.zoo", "x", eq_condition = "equal", index = 1)
test_function("plot.zoo", "x", eq_condition = "equal", index = 2)
...
*** =hint
You can access the end of period weights from your portfolios using `portfolio$EOP.Weight`.
*** =pre_exercise_code
```{r}
# pec
options(warn=-1)
