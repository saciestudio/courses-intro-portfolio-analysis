...
--- type:VideoExercise lang:r xp:50 skills:1
## The timing of the portfolio decisions
...
--- type:NormalExercise lang:r xp:100 skills:1
## PerformanceAnalytics for computing the time series of portfolio returns
...
Let us explore this functionality in the case of a portfolio invested in the Apple stock and Microsoft stock, for which the prices are available in the variables `aapl` and `msft` in the R environment.  
