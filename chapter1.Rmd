...
Convert the DJIA price data into a return data. Use head( ) and tail( ) to print the first 6 and last 6 rows. 
...
The equally  weighted portfolio has the return equal to the average. use rowMeans( ) to compute it and make a  time series plot. Use table.CalandarReturns in PerformanceAnalytics to present as month x year.
