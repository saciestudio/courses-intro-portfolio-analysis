...
Let us now continue the exercise by computing the portfolio returns under different settings. 

  The target weights are the same for each rebalancing data. We call this the constant mix portfolio allocation strategy.   
...
## The effect of the frequency of rebalancing (improve)
