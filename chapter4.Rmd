...
- Create three empty vectors with the same length as `grid`, where you will store the portfolio means, standard deviations, and weights. Call these `vpm`, `vpsd`, `mweights` respectively.
