...
Using the *PerformanceAnalytics* package makes finding the optimized portfolio under weight constraints easy. The function `portfolio.optim()` allows you to set weight constraints within the `reshigh` argument. `reshigh` requires a vector of maximum weights for each asset. 
...
#5
test_output_contains("sum(optim1$pw > .01)", incorrect_msg = "Make sure you count how many assets have a weight greater than 1% for `optim1`!")
test_output_contains("sum(optim2$pw > .01)", incorrect_msg = "Make sure you count how many assets have a weight greater than 1% for `optim2`!")
test_output_contains("sum(optim3$pw > .01)", incorrect_msg = "Make sure you count how many assets have a weight greater than 1% for `optim3`!")
