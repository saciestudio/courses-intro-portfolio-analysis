...
*** =hint
The only argument you need to provide is the stock return data.
*** =pre_exercise_code
```{r}
# pec
library(xts)
...
*** =hint
Portfolio analysis is still an active field of research among academics and practitioners.
