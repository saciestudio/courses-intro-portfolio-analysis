...
test_output_contains("par(mfrow = c(2, 1), mar = c(3, 2, 2, 1))")
test_output_contains("barplot(weights_minvar[weights_minvar > 0.01])")
test_output_contains("barplot(weights_max_sr[weights_max_sr > 0.01])")
