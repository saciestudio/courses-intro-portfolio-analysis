...
- Create a sequence of length 50, that begins at the minimum value of `stockmu` and ends at the maximum value of `stockmu` called `grid`.
...
test_output_contains("for(i in 2:lenght(grid))", incorrect_msg = "Make sure that your for loops starts on the second iteration of `grid`.")
# sct code
success_msg("Well done!")
```
