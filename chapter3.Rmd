...
So far in the previous chapters you have seen that there are three types of drivers for a portfolio's performance:
  - the individual performance of the assets in terms of risk and return
  - the portfolio weight of each of the assets
  - the correlation between the asset returns. 
  
You will now explore how the portfolio mean return and volatility depends on the mean returns and volatility of the assets that a portfolio is invested in. In this example you will consider investing—with monthly frequency—in US equities and US bonds. Each asset's returns are stored in your workspace as  `returns_equities`, and `returns_bonds`. You have a portfolio that is invested 60/40, meaning that every month you invest 60% in equities, and 40% bonds.
...
Investors know that each asset that they invest in has risk, and that each asset performs differently. Thats why you will not only invest in US equities and US bonds, but you will *diversify* your portfolio by investing in real estate, commoditites, among others! 
