...
```{r}
#1st
test_function("apply", c("X", "MARGIN", "FUN"), not_called_msg not_called_msg = "Be sure to calculate column-wise means!", incorrect_msg = "Did you specify the correct function?")

#2nd
test_function("apply", c("X", "MARGIN", "FUN"), not_called_msg = "Oops! Did you calculate column-wise standard deviations?", incorrect_msg = "Did you specify the correct function?")
