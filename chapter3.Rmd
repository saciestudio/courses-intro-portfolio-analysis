...
*** =sct
```{r}
test_output_contains("12 * (t(w) %*% mu)")
test_output_contains("sqrt(12) * sqrt(t(w) %*% sigma %*% w)")
test_output_contains("12 * mean(preturns)")
test_output_contains("sqrt(12) * sd(preturns)")
