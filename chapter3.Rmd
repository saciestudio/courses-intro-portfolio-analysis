...
*** =instructions
- A portfolio is less volatile than the sum of its component volatilities: the standard deviation of the 60/40 portfolio is less than `0.6*sd(returns_equities)+0.4*sd(returns_bonds)`.   
