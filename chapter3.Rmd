...
To get a feeling for this dependence, let us analyze the monthly returns of an investment in US equities and an investment in US bonds.  The individual returns are available in the workspace as `returns_bonds` and `returns_equities`, together with the returns for the so-called 60/40 portfolio that invests every month 60% in equities and 40% in bonds.  
...
*** =hint
The proof is in the pudding. Verify the statements directly in the console and you will find out the solution to the problem.
