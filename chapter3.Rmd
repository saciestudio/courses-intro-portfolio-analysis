...
- When the risk free rate is zero, the Sharpe ratio equals the sum of the component Sharpe ratios (that is, `mean(returns_6040)/sd(returns_6040)==0.6*mean(returns_equities)/sd(returns_equities)
